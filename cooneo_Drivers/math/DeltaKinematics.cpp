...
// constexpr double sin120 = sqrt3 / 2.0;
// constexpr double cos120 = -0.5;
// constexpr double tan60 = sqrt3;
// constexpr double sin30 = 0.5;
// constexpr double tan30 = 1.0 / sqrt3;

// constexpr int non_existing_point_error = -2;
...
//     : ArmLength(_ArmLength), RodLength(_RodLength), BassTri(_BassTri), PlatformTri(_PlatformTri), x(0.0), y(0.0), z(0.0), a(0.0), b(0.0), c(0.0)
// {
// }
...
//     if (dV < 0.0)
//     {
//         return 0; // non_existing_povar_error; // non-existing povar. return error,x,y,z
//     }
...
//     if (dV < 0)
//     {
//         return 0; //non_existing_povar_error; // non-existing povar.  return error, theta
//     }
...
//     {
//         return new DeltaKinematics(_ArmLength, _RodLength, _BassTri, _PlatformTri);
//     }

//     void DeltaKinematics_destroy(void *dk)
//     {
//         delete static_cast<DeltaKinematics *>(dk);
//     }

//     int DeltaKinematics_forward_with_angles(void *dk, double thetaA, double thetaB, double thetaC)
//     {
//         return static_cast<DeltaKinematics *>(dk)->forward(thetaA, thetaB, thetaC);
//     }

//     int DeltaKinematics_inverse_with_positions(void *dk, double x0, double y0, double z0)
//     {
//         return static_cast<DeltaKinematics *>(dk)->inverse(x0, y0, z0);
//     }
